...
import io.alcatraz.libalcatrazui.adapters.SetupPagerAdapter
import io.alcatraz.libalcatrazui.beans.SetupPage
import io.alcatraz.libalcatrazui.utils.AnimateUtils.textChange
import io.alcatraz.libalcatrazui.utils.SharedPreferenceUtil
import io.alcatraz.libalcatrazui.utils.Utils.getNavigationBarHeight
import io.alcatraz.libalcatrazui.utils.Utils.getTintedDrawable
import io.alcatraz.libalcatrazui.utils.Utils.setImageWithTint
import io.alcatraz.libalcatrazui.views.NoScrollViewPager
...
abstract class SetupWizardBaseActivity : CompatWithPipeActivity() {
    ...
    fun getPager(): NoScrollViewPager {
        return setup_pager
    }
    ...
    private fun initPrefs() {
        version =
            SharedPreferenceUtil.getPref(
                this,
                createPrefKey(PREF_ACTION_PREVIOUS_VERSIONCODE),
                getVersionCode()
            ) as Int
        hasRunFullSetup = SharedPreferenceUtil.getPref(
            this, createPrefKey(
                PREF_ACTION_HAS_RUN_FULL_SETUP
            ), false
        ) as Boolean
    }
